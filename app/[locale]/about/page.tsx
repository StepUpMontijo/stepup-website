        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div className="lg:col-span-4 h-full flex items-center w-full">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-100 h-full flex items-center w-full">
            ...
            <div className="lg:col-span-8 lg:col-start-5 h-full">
              <div className="relative h-full">
                <div className="relative overflow-hidden rounded-3xl shadow-lg border border-slate-100 aspect-video h-full">
                  <iframe
